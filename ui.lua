...
function library:Init(key)
    ...
    function TabLibrary:NewTab(title)
        ...
        page.ScrollBarImageColor3 = Color3.fromRGB(120, 0, 0)
        page.Visible = false
        ...
        if TabLibrary.IsFirst then
            page.Visible = true
            tabButton.TextColor3 = Color3.fromRGB(120, 0, 0)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            TweenService:Create(tabButton, TweenTable["tab_text_colour"], {TextColor3 = Color3.fromRGB(120, 0, 0)}):Play()
        end)
        ...
        function Components:NewButton(text, callback)
            ...
            button.MouseButton1Down:Connect(function()
                TweenService:Create(buttonLabel, TweenTable["hover"], {TextColor3 = Color3.fromRGB(120, 0, 0)}):Play()
            end)
        ...
        function Components:NewToggle(text, default, callback)
            ...
            toggleDesignGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(180, 0, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(80, 0, 0))}
        ...
        function Components:NewTextbox(text, default, place, format, type, autoexec, autoclear, callback)
            ...
            if type == "small" then
                ...
                textBoxValues.Focused:Connect(function()
                    textBoxValues:GetPropertyChangedSignal("Text"):Connect(ResizeTextBox)
                    TweenService:Create(textbox, TweenTable["TextBox"], {BackgroundColor3 = Color3.fromRGB(120, 0, 0)}):Play()
                end)
        ...
        function Components:NewSelector(text, default, list, callback)
            ...
            for i,v in next, list do
                ...
                if optionButton.Text == default then
                    optionButton.TextColor3 = Color3.fromRGB(120, 0, 0)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    ...
                    TweenService:Create(optionButton, TweenTable["selector"], {TextColor3 = Color3.fromRGB(120, 0, 0)}):Play()
        ...
        function Components:NewSlider(text, suffix, compare, compareSign, values, callback)
            ...
            sliderIndicatorGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(120, 0, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(128, 94, 208))}
